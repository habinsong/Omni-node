...
const routineSchedulePolicy = read("apps/omninode-middleware/src/RoutineSchedulePolicy.cs");
const commandServiceRoutineManagement = read("apps/omninode-middleware/src/CommandService.RoutineManagement.cs");
