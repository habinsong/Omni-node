...
| 계획과 task graph 보존/실행 기준이 필요할 때 | `docs/PLANNING_AND_TASKS.md` |
| 노트북과 handoff 원본을 판단해야 할 때 | `docs/NOTEBOOKS_AND_HANDOFF.md` |
| 설정 탭 고급 도구 상태를 볼 때 | `docs/도구_통합_패널_사용_가이드.md` |
